...
namespace Sample
{
    ...
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        private void Initialize()
        {
            ...
            Stream stream = assembly.GetManifestResourceStream("Sample.Assets.Tiger.xaml");
            using (StreamReader reader = new StreamReader(stream))
            {
                animals.Add("Tiger", reader.ReadToEnd());
            }

            stream = assembly.GetManifestResourceStream("Sample.Assets.Lion.xaml");
            using (StreamReader reader = new StreamReader(stream))
            {
                animals.Add("Lion", reader.ReadToEnd());
            }

            stream = assembly.GetManifestResourceStream("Sample.Assets.Panda.xaml");
            using (StreamReader reader = new StreamReader(stream))
            {
                animals.Add("Panda", reader.ReadToEnd());
            }

            stream = assembly.GetManifestResourceStream("Sample.Assets.Bear.xaml");
            using (StreamReader reader = new StreamReader(stream))
            {
                animals.Add("Bear", reader.ReadToEnd());
            }

            stream = assembly.GetManifestResourceStream("Sample.Assets.Deer.xaml");
            using (StreamReader reader = new StreamReader(stream))
            {
